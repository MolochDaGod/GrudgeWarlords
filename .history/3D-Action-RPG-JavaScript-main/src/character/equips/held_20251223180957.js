...
function attachSwordToBone(sword, rightHand) {
    // Adjusted for racalvin scale (3.7x HumanBaseMesh)
    let position = new BABYLON.Vector3(0, 7, 2.7);  // 26/3.7 ≈ 7
    let scaling = new BABYLON.Vector3(135, 135, 135);  // 500/3.7 ≈ 135
